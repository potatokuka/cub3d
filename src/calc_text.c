...
/*   Updated: 2020/06/30 20:49:25 by greed         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ray->side == 0)
		ray->text_west.wall_x = ray->play.pos.y +
			ray->perp_wall_dist * ray->ray_dir_y;
	else
		ray->text_west.wall_x = ray->play.pos.x +
...
{
	if (ray->side == 0)
		ray->text_east.wall_x = ray->play.pos.y +
			ray->perp_wall_dist * ray->ray_dir_y;
	else
		ray->text_east.wall_x = ray->play.pos.x +
			ray->perp_wall_dist * ray->ray_dir_x;
...
{
	if (ray->side == 0)
		ray->text_south.wall_x = ray->play.pos.y +
			ray->perp_wall_dist * ray->ray_dir_y;
	else
		ray->text_south.wall_x = ray->play.pos.x +
			ray->perp_wall_dist * ray->ray_dir_x;
...
{
	if (ray->side == 0)
		ray->text_north.wall_x = ray->play.pos.y +
			ray->perp_wall_dist * ray->ray_dir_y;
	else
		ray->text_north.wall_x = ray->play.pos.x +
			ray->perp_wall_dist * ray->ray_dir_x;
